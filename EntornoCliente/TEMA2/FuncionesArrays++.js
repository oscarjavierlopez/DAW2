...
console.log(valores.fill(5)); //rellena todo el array con 5
var valores = [6,4,8,3,9,6];
...
//Tercer valor: Índice del array hasta el que se introduce(si no hay tercer valor rellena hasta el final del array)
...
//Selecciona desde índice 2 hasta índice 7-1
var letras = ["A","B","C","D","E","F","G","H","I","J"];
console.log("Array inicial: " + letras);
...
var lista2 = Array.from([1,2,3,4],function (x) { //crea el array del objeto [1,2,3,4]convirtiendolo a lo que le pasemos en la funcion
	return x*10;
});
console.log(lista2);

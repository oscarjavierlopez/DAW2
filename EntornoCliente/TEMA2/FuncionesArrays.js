...
let StringNumeros = numeros.join(" "); //le tenemos que pasar una string que separará los elementos del array
...
numeros.sort((a,b) => a - b); //sin esa funcion flecha se ordena como String
...
let primerosNumeros = numeros.slice(0 , 2); //Crea una rebanada desde el elemento en la posicion del primer parametro hasta el elemento del segundo parametro - 1

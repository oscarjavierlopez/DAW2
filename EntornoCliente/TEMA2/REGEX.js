...
/*
 [
  'abcabcx4',   // [0] → Coincidencia completa con toda la expresión regular
  'abc',        // [1] → Primer grupo capturado: `(abc)` → aunque se repite 2 veces, solo se guarda la última
  'x4',         // [2] → Segundo grupo capturado: `(.\d)`
